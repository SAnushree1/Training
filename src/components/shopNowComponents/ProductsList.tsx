...
const ProductsList: React.FC = () => {
    ...
    const [filteredProducts, setFilteredProducts] = useState<Product[]>(productDetails as Product[]);
    ...
    useEffect(() => {
        ...
        if (!hasFilters) {
            setFilteredProducts(productDetails as Product[]);
            return;
        }

        const filtered = (productDetails as Product[]).filter((product) => {
            // console.log(product);
