    ...
    <div className='flex bg-white rounded-2xl mb-1'>
        ...
        <div className='flex w-3/4 m-5 justify-between '>
            <div>
                ...
                <div className='inline-flex p-2 bg-[#ffb9b9] rounded-2xl my-3 hover:bg-[#fee9e9] hover:text-gray-500 gap-5'>
                    <button onClick={ () => removeFromCart(productId)}> {item.quantity === 1 ? "🗑️" : "-"}</button>
                    <p>{item.quantity}</p>
